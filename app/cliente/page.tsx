...
function Header(){return <header className="topbar"><Link className="brand" href="/"><span className="brandMark">ME</span><span><strong>Manicure Expert</strong><small>Sua manicure onde voce estiver.</small></span></Link><nav className="navLinks"><Link href="/profissional">Profissional</Link><Link href="/gestao">Gestao</Link></nav><div className="navAccount"><Link className="navAction" href="/login">Entrar</Link><LogoutButton /></div></header>}
